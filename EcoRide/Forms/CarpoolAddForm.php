...
if ((isset($_POST['carpool_add_submit'])) && (!empty($_POST['carpool_add_submit']))) {
    ...
    */
    ...
    if ((!isset($_POST['price_of_a_place'])) || (empty($_POST['price_of_a_place']))) {
        ...
        $new_carpool->setDepartureDate($_POST['departure_date']);
        $new_carpool->setDepartureTime($_POST['departure_time']);
        $new_carpool->setDeparturePlace($_POST['departure_place']);
        $new_carpool->setArrivalDate($_POST['arrival_date']);
        $new_carpool->setArrivalTime($_POST['arrival_time']);
        $new_carpool->setArrivalPlace($_POST['arrival_place']);
        $new_carpool->setStatus(false);
        $new_carpool->setNumberOfPlaces((int) $_POST['number_of_places']);
        $new_carpool->setPriceOfAPlace($_POST['price_of_a_place']);
